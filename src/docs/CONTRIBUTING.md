...
### Testing standards
- Framework: Vitest; global setup at `src/__tests__/setup.ts`.
- Coverage provider: v8. LCOV written to `coverage/lcov.info` (used by SonarCloud).
- Keep 100% coverage on changed files. Add tests alongside code in `src/__tests__/unit/**`.
